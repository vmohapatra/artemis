...
//input, list, options as parameters
            ...
            if (allowed) {
                ...
                if(this.opts.selectionCallback) { 
                    if (typeof this.opts.selectionCallback == 'function') {
                        ...
                        window[this.opts.selectionCallback](suggestion.data);
                    }
                };
            }
        }
...
function Suggestion(data) {
    ...
    this.value = o.value;
    // Add a data attribute to send for the suggestion
    this.data = data;
}
